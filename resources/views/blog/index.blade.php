...
<section class="py-20 bg-white">
    <div class="container mx-auto px-6 md:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {{-- CARD 2: LISBOA, CASCAIS E ALGARVE (LINK ATUALIZADO) --}}
            ...
            {{-- CARD 3: LIFESTYLE (Placeholder) --}}
            <article class="group flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
                <div class="h-64 overflow-hidden mb-6 bg-gray-100 rounded-sm relative">
                    <span class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 text-[10px] uppercase tracking-widest z-10">Lifestyle</span>
                    <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=800" class="w-full h-full object-cover transition duration-700 group-hover:scale-105 grayscale group-hover:grayscale-0" alt="Lifestyle">
                </div>
                <div class="flex-grow flex flex-col">
                    <h4 class="text-xl font-serif mb-4 leading-snug group-hover:text-brand-gold transition">
                        <a href="#">
                            Arquitetura Sustentável: O Novo Padrão de Exigência
                        </a>
                    </h4>
                    <p class="text-sm text-gray-500 font-light leading-relaxed mb-6 flex-grow line-clamp-3">
                        A sustentabilidade deixou de ser um diferencial para se tornar um requisito obrigatório nos empreendimentos de alto padrão.
                    </p>
                    <a href="#" class="text-[10px] uppercase tracking-widest font-bold hover:text-brand-gold mt-auto inline-block">Ler Mais »</a>
                </div>
            </article>
